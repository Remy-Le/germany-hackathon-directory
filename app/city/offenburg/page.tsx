...
export default function OffenburgPage() {
	const city = cities.find(c => c.slug === 'offenburg');
	const hackathons = getHackathonsByCity(city?.name || '');

	const cityInfo = {
		title: 'Offenburg – Black Forest Innovation',
		description:
			'Offenburg is the gateway to the Black Forest and a hotspot for smart region, sustainability, and mobility hackathons. The city brings together tech, nature, and community-driven innovation.'
	};
